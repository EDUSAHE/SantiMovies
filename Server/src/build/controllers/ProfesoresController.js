...
class ProfesoresController {
    ...
    listOne(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const respuesta = yield database_1.default.query('SELECT * FROM profesores WHERE idUsuario=?', [id]);
    ...
    existe(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let consulta = "SELECT idUsuario,password, nivel FROM profesores WHERE correo = '" + correo + "'";
    ...
    delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resp = yield database_1.default.query(`DELETE FROM profesores WHERE idUsuario=${idUsuario}`);
            res.json(resp);
        });
    }
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { idUsuario } = req.params;
            const resp = yield database_1.default.query('UPDATE profesores set ? WHERE idUsuario=?', [req.body, idUsuario]);
            res.json(resp);
        });
    }
    ...
    getProfesoresByArticulo(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const respuesta = yield database_1.default.query('SELECT P.nombreProfesor, P.idUsuario FROM profesores as P INNER JOIN profesorYarticulo PA ON PA.idUsuario=P.idUsuario WHERE PA.idArticulo=?', idArticulo);
            res.json(respuesta);
        });
    }
    ...
    updateDatosPersonales(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resp = yield database_1.default.query('UPDATE profesores SET nombreProfesor=?,correo = ?,grado = ? WHERE idUsuario = ?', [nombreProfesorNuevo, correoNuevo, gradoNuevo, idUsuario]);
            res.json(resp);
        });
    }
    listProfesorByInstituto(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < resp.length; i++) {
                resp[i].profesores = yield database_1.default.query(`SELECT * FROM profesores WHERE profesores.idInstituto=${resp[i].idInstituto} ORDER BY idUsuario`);
            }
            res.json(resp);
        });
    }
